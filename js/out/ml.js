...
var V = class _V {
  constructor({ strings: t3, _$litType$: i4 }, e6) {
    ...
    if (this.el = _V.createElement(a3, e6), C.currentNode = this.el.content, 2 === i4) {
...
var M = class _M {
  ...
  T(t3) {
    ...
    let s5, e6 = 0;
    for (const o6 of t3)
      e6 === i4.length ? i4.push(s5 = new _M(this.k(d2()), this.k(d2()), this, this.options)) : s5 = i4[e6], s5._$AI(o6), e6++;
...
// src/ml/optional-shiny.ts
var Shiny = window.Shiny;

// src/ml/make-output-binding.ts
...
// src/ml/classification-label.ts
var ShinyClassificationLabel = class extends s4 {
  constructor() {
    super(...arguments);
    this.value = {};
    this.sort = 1;
  ...
  render() {
    ...
    if (this.sort) {
      entries.sort((a3, b2) => b2[1] - a3[1]);
    }
    const valuesHtml = entries.map(([k2, v2]) => {
      return x`<div class="item">
        <div class="bar" style="width: ${v2}%;"></div>
        <div class="label">
          <div>${k2}</div>
    ...
    return x` <div class="wrapper">${valuesHtml}</div> `;
  }
};
__decorateClass([
  n5({ type: Object })
], ShinyClassificationLabel.prototype, "value", 2);
__decorateClass([
  n5({ type: Number })
], ShinyClassificationLabel.prototype, "sort", 2);
